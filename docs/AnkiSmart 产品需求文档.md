...
| 打包分发复杂度 | PaddleOCR + PyQt6 体积较大，安装门槛高 | v1.1 规划打包方案（PyInstaller / Nuitka），模型按需下载 |
...
4. Qt 6 Widgets 官方文档：https://doc.qt.io/qt-6/qtwidgets-index.html
