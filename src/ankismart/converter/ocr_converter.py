...
def _build_ocr_kwargs(device: str) -> dict[str, object]:
    det_model = os.getenv("ANKISMART_OCR_DET_MODEL", "PP-OCRv4_mobile_det")
    rec_model = os.getenv("ANKISMART_OCR_REC_MODEL", "PP-OCRv4_mobile_rec")
    ...
    ocr_version = os.getenv("ANKISMART_OCR_VERSION", "PP-OCRv4")
    lang = os.getenv("ANKISMART_OCR_LANG", "ch")
