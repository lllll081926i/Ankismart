...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "import.target_card_count": {
        "zh": "目标卡片数量",
        "en": "Target Card Count",
    },
    "import.target_card_count_desc": {
        "zh": "设置要生成的卡片总数",
        "en": "Set total number of cards to generate",
    },
    "import.deck_name": {"zh": "卡片组名称", "en": "Deck Name"},
    "import.deck_name_desc": {
        "zh": "选择或输入 Anki 卡片组名称",
    ...
    "import.strategy.basic_desc": {
        "zh": "生成基础问答卡片",
        "en": "Generate basic Q&A cards",
    },
    "import.strategy.cloze": {"zh": "填空题", "en": "Cloze"},
    "import.strategy.cloze_desc": {
        "zh": "生成填空题卡片",
        "en": "Generate cloze cards",
    },
    "import.strategy.concept": {"zh": "概念解释", "en": "Concept"},
    "import.strategy.concept_desc": {
        "zh": "生成概念解释卡片",
        "en": "Generate concept cards",
    },
    "import.strategy.key_terms": {"zh": "关键术语", "en": "Key Terms"},
    "import.strategy.key_terms_desc": {
        "zh": "生成关键术语卡片",
        "en": "Generate key term cards",
    },
    "import.strategy.single_choice": {"zh": "单选题", "en": "Single Choice"},
    "import.strategy.single_choice_desc": {
        "zh": "生成单选题卡片",
        "en": "Generate single choice cards",
    },
    "import.strategy.multiple_choice": {"zh": "多选题", "en": "Multiple Choice"},
    "import.strategy.multiple_choice_desc": {
        "zh": "生成多选题卡片",
        "en": "Generate multiple choice cards",
    },
    # Import page - Actions
    ...
    "import.converting_file": {
        "zh": "正在转换: {filename} ({current}/{total})",
        "en": "Converting: {filename} ({current}/{total})",
    },
    "import.converting_file_with_page": {
        "zh": "正在转换: {filename} (第 {page}/{total_pages} 页)",
        "en": "Converting: {filename} (Page {page}/{total_pages})",
    },
    "import.overall_progress": {
        "zh": "{percentage}% ({current}/{total} 文件)",
        "en": "{percentage}% ({current}/{total} files)",
    },
    "import.ocr_page_progress": {
        "zh": "正在识别第 {page}/{total_pages} 页",
        "en": "Recognizing page {page}/{total_pages}",
    },
    "import.conversion_complete": {
        "zh": "转换完成: {count} 个文件",
        "en": "Conversion completed: {count} files",
    },
    "import.no_files_converted": {
        "zh": "没有成功转换的文件",
        "en": "No files converted successfully",
    },
    "import.conversion_failed": {
        "zh": "转换失败: {error}",
        "en": "Conversion failed: {error}",
    },
    # Import page - Validation
    "import.warning": {"zh": "警告", "en": "Warning"},
    "import.please_select_files": {
        "zh": "请先选择文件",
        "en": "Please select files first",
    },
    "import.please_configure_provider": {
        "zh": "请先配置 LLM 提供商",
        "en": "Please configure LLM provider first",
    },
    "import.please_configure_api_key": {
        "zh": "请先配置 API Key",
        "en": "Please configure API Key first",
    },
    "import.please_enter_deck_name": {
        "zh": "请输入牌组名称",
    ...
    "import.some_files_failed": {
        "zh": "部分文件转换失败:\n{errors}",
        "en": "Some files failed to convert:\n{errors}",
    },
    ...
    "import.invalid_card_count": {
        "zh": "目标卡片数量无效",
        "en": "Invalid Card Count",
    },
    "import.card_count_must_be_number": {
        "zh": "目标卡片数量必须是正整数",
        "en": "Target card count must be a positive integer",
    },
    "import.card_count_out_of_range": {
        "zh": "目标卡片数量必须在 1-1000 之间",
        "en": "Target card count must be between 1 and 1000",
    },
    "import.invalid_tags": {
        "zh": "标签格式无效",
        "en": "Invalid Tags Format",
    },
    "import.tags_contain_invalid_chars": {
        "zh": (
        ...
        "en": (
            ...
            "numbers, Chinese characters, underscores, and hyphens.\nSeparate "
            "multiple tags with commas.\n\nExample: ankismart, important, review_2024"
        ),
    },
    "import.invalid_deck_name": {
        "zh": "牌组名称无效",
        "en": "Invalid Deck Name",
    },
    "import.deck_name_empty": {
        "zh": "牌组名称不能为空",
        "en": "Deck name cannot be empty",
    },
    "import.deck_name_invalid_chars": {
        "zh": (
            "牌组名称包含非法字符。\n\n"
            '牌组名称不能包含以下字符：< > : " / \\ | ? *\n\n示例：Default, 英语学习, '
            "Math_2024"
    ...
    "import.card_count_placeholder": {
        "zh": "输入 1-1000 之间的数字",
        "en": "Enter a number between 1-1000",
    },
    "import.card_count_tooltip": {
        "zh": "设置要生成的卡片总数（1-1000）",
        "en": "Set total number of cards to generate (1-1000)",
    },
    "import.deck_name_placeholder": {
        "zh": "输入牌组名称",
        "en": "Enter deck name",
    },
    ...
    "import.downloading_ocr_models": {
        "zh": "正在下载 OCR 模型",
        "en": "Downloading OCR Models",
    },
    ...
    "import.select_example": {
        "zh": "选择示例文档",
        "en": "Select Example Document",
    },
    "import.example_comprehensive": {
        "zh": "综合知识示例",
    ...
    "import.rec_general_desc": {
        "zh": "混合类型内容，使用平衡策略",
        "en": "Mixed content type, using balanced strategy",
    },
    # Preview page
    "preview.title": {
        "zh": "文档预览与编辑",
        "en": "Document Preview & Edit",
    },
    "preview.edit_placeholder": {
        "zh": "在此编辑 Markdown 内容...",
        "en": "Edit Markdown content here...",
    },
    ...
    "result.retry_failed": {
        "zh": "重试失败卡片",
        "en": "Retry Failed Cards",
    },
    "result.export_failed": {
        "zh": "导出失败卡片",
        "en": "Export Failed Cards",
    },
    ...
    "result.batch_edit_deck": {
        "zh": "批量修改牌组",
        "en": "Batch Edit Deck",
    },
    "result.batch_edit_tags_title": {
        "zh": "批量编辑标签",
        "en": "Batch Edit Tags",
    },
    "result.batch_edit_deck_title": {
        "zh": "批量修改牌组",
        "en": "Batch Edit Deck",
    },
    "result.selected_cards_count": {
        "zh": "已选择 {count} 张卡片",
        "en": "{count} cards selected",
    },
    "result.tags_placeholder": {
        "zh": "输入标签，用逗号分隔",
        "en": "Enter tags, separated by commas",
    },
    "result.tags_hint": {
        "zh": "例如：重要, 复习, 考试",
        "en": "Example: important, review, exam",
    },
    "result.deck_placeholder": {
        "zh": "输入牌组名称",
        "en": "Enter deck name",
    },
    "result.deck_hint": {
        "zh": "例如：Default, 英语学习, 数学",
        "en": "Example: Default, English, Math",
    },
    "result.batch_edit_success": {
        "zh": "批量编辑成功",
        "en": "Batch Edit Success",
    },
    "result.batch_tags_updated": {
        "zh": "已更新 {count} 张卡片的标签",
        "en": "Updated tags for {count} cards",
    },
    "result.batch_deck_updated": {
        "zh": "已更新 {count} 张卡片的牌组",
        "en": "Updated deck for {count} cards",
    },
    # Result page - Duplicate Check Settings
    "result.duplicate_check_settings": {
        "zh": "重复检查设置",
        "en": "Duplicate Check Settings",
    },
    "result.duplicate_scope": {"zh": "检查范围", "en": "Check Scope"},
    "result.duplicate_scope_desc": {
        "zh": "设置重复检查的范围",
        "en": "Set the scope for duplicate checking",
    },
    ...
    "result.duplicate_check_model_desc": {
        "zh": "是否检查笔记类型是否相同",
        "en": "Whether to check if note type matches",
    },
    "result.allow_duplicate": {"zh": "允许重复", "en": "Allow Duplicates"},
    "result.allow_duplicate_desc": {
        "zh": "允许创建重复的卡片",
        "en": "Allow creating duplicate cards",
    },
    # Result page - Messages
    "result.push_success_msg": {"zh": "推送成功", "en": "Push Success"},
    "result.push_success_detail": {
        "zh": "成功推送 {count} 张卡片",
        "en": "Successfully pushed {count} cards",
    },
    "result.partial_failure": {"zh": "部分失败", "en": "Partial Failure"},
    "result.partial_failure_detail": {
        "zh": "成功 {succeeded} 张，失败 {failed} 张",
        "en": "Success {succeeded}, Failed {failed}",
    },
    "result.no_failed_cards": {"zh": "提示", "en": "Info"},
    "result.no_failed_cards_msg": {
        "zh": "没有失败的卡片需要重试",
        "en": "No failed cards to retry",
    },
    "result.retrying": {"zh": "重试中", "en": "Retrying"},
    "result.retrying_msg": {
        "zh": "正在重试 {count} 张失败卡片...",
        "en": "Retrying {count} failed cards...",
    },
    "result.retry_success": {"zh": "重试成功", "en": "Retry Success"},
    "result.retry_success_msg": {
        "zh": "成功推送 {count} 张卡片",
        "en": "Successfully pushed {count} cards",
    },
    "result.retry_all_failed": {"zh": "重试失败", "en": "Retry Failed"},
    "result.retry_all_failed_msg": {
        "zh": "所有卡片重试失败",
        "en": "All cards retry failed",
    },
    "result.retry_error": {"zh": "重试错误", "en": "Retry Error"},
    "result.no_failed_to_export": {
        "zh": "没有失败的卡片需要导出",
        "en": "No failed cards to export",
    },
    "result.export_failed_cards": {
        "zh": "导出失败卡片",
        "en": "Export Failed Cards",
    },
    "result.exporting": {"zh": "导出中", "en": "Exporting"},
    "result.exporting_msg": {
        "zh": "正在导出 {count} 张失败卡片...",
        "en": "Exporting {count} failed cards...",
    },
    "result.export_success": {"zh": "导出成功", "en": "Export Success"},
    "result.export_success_msg": {
        "zh": "已导出到 {path}",
        "en": "Exported to {path}",
    },
    ...
    "settings.add_provider_desc": {
        "zh": "添加新的 LLM 提供商配置",
        "en": "Add new LLM provider configuration",
    },
    "settings.provider_dialog_title": {
        "zh": "LLM 提供商配置",
        "en": "LLM Provider Configuration",
    },
    "settings.provider_name_placeholder": {
        "zh": "提供商名称（例如：OpenAI）",
        "en": "Provider name (e.g., OpenAI)",
    },
    "settings.base_url_placeholder": {
        "zh": "基础 URL（例如：https://api.openai.com/v1）",
        "en": "Base URL (e.g., https://api.openai.com/v1)",
    },
    "settings.api_key_placeholder": {"zh": "API 密钥", "en": "API Key"},
    "settings.model_placeholder": {
        "zh": "模型（例如：gpt-4o）",
        "en": "Model (e.g., gpt-4o)",
    },
    "settings.rpm_limit_prefix": {"zh": "RPM 限制: ", "en": "RPM Limit: "},
    "settings.provider_name_required": {
        "zh": "提供商名称为必填项",
    ...
    "settings.anki_url_desc": {
        "zh": "AnkiConnect API 的 URL 地址",
        "en": "URL address of AnkiConnect API",
    },
    ...
    "settings.anki_key_desc": {
        "zh": "AnkiConnect 的可选 API 密钥",
        "en": "Optional API key for AnkiConnect",
    },
    "settings.anki_key_placeholder": {
        "zh": "可选的 API 密钥",
        "en": "Optional API key",
    },
    "settings.default_deck": {"zh": "默认牌组", "en": "Default Deck"},
    "settings.default_deck_desc": {
        "zh": "新卡片的默认 Anki 牌组",
        "en": "Default Anki deck for new cards",
    },
    ...
    "settings.test_connection_desc": {
        "zh": "测试与 AnkiConnect 的连接",
        "en": "Test connection to AnkiConnect",
    },
    "settings.testing_anki": {
        "zh": "正在检测 AnkiConnect 连接...",
        "en": "Testing AnkiConnect connection...",
    },
    "settings.anki_connected": {
        "zh": "AnkiConnect 连通正常",
    ...
    "settings.proxy_desc": {
        "zh": "HTTP/HTTPS 代理 URL（可选）",
        "en": "HTTP/HTTPS proxy URL (optional)",
    },
    "settings.proxy_placeholder": {
        "zh": "http://proxy.example.com:8080",
        "en": "http://proxy.example.com:8080",
    },
    "settings.ocr_correction": {"zh": "OCR 校正", "en": "OCR Correction"},
    "settings.ocr_correction_desc": {
    ...
    "settings.auto_split_threshold_desc": {
        "zh": "触发自动分割的字符数阈值",
    ...
    "settings.cache_size_desc": {
        "zh": "当前缓存占用的磁盘空间",
        "en": "Current cache disk usage",
    },
    "settings.cache_count": {"zh": "缓存文件数", "en": "Cache Files"},
    "settings.cache_count_desc": {
        "zh": "缓存文件总数量",
        "en": "Total number of cache files",
    },
    ...
    "settings.cache_clear_failed_msg": {
        "zh": "清空缓存时发生错误",
        "en": "Error occurred while clearing cache",
    },
    "settings.cache_empty": {"zh": "缓存为空", "en": "Cache Empty"},
    "settings.cache_empty_msg": {
        "zh": "当前没有缓存文件",
        "en": "No cache files currently",
    },
    # Settings page - Performance Statistics
    "settings.performance_stats": {
        "zh": "性能统计",
        "en": "Performance Statistics",
    },
    "settings.total_files": {
        "zh": "总处理文件数",
        "en": "Total Files Processed",
    },
    "settings.total_files_desc": {
        "zh": "已成功处理的文件总数",
        "en": "Total number of files successfully processed",
    },
    "settings.avg_conversion_time": {
        "zh": "平均转换时间",
    ...
    "settings.total_cards": {
        "zh": "总生成卡片数",
        "en": "Total Cards Generated",
    },
    "settings.total_cards_desc": {
        "zh": "已成功生成的卡片总数",
        "en": "Total number of cards successfully generated",
    },
    "settings.reset_stats": {"zh": "重置统计", "en": "Reset Statistics"},
    "settings.reset_stats_title": {
        "zh": "重置统计数据",
        "en": "Reset Statistics",
    },
    "settings.reset_stats_desc": {
        "zh": "清除所有性能统计数据",
        "en": "Clear all performance statistics data",
    },
    "settings.confirm_reset_stats": {
        "zh": "确认重置统计",
    ...
    "settings.stats_reset_success_msg": {
        "zh": "性能统计数据已清除",
        "en": "Performance statistics data cleared",
    },
    ...
    "settings.reset_complete_msg": {
        "zh": "设置已恢复为默认值",
        "en": "Settings restored to default values",
    },
    "settings.error": {"zh": "错误", "en": "Error"},
    "settings.must_have_provider": {
        "zh": "至少需要配置一个 LLM 提供商",
        "en": "At least one LLM provider must be configured",
    },
    ...
    # File filters
    "file.all_supported": {
        "zh": "All Supported (*.md *.txt *.docx *.pptx *.pdf *.png *.jpg *.jpeg);;All Files (*.*)",
    ...
    "error.file_too_large.suggestion": {
        ...
        "en": (
            "• Compress or split files (<=200MB)\n• Split PDF to keep each file <=600 "
    ...
    "error.rate_limit.message": {
        "zh": "触发接口限频（Rate Limit），请稍后重试",
        "en": "API rate limit reached, please retry later",
    },
    "error.rate_limit.suggestion": {
        ...
        "en": (
            "• Reduce concurrency/polling frequency and retry\n• MinerU reference limits: "
            "submit 300 req/min, query 1000 req/min\n• Upgrade plan or retry at "
            "off-peak hours"
        ),
    },
    ...
    "error.quota_exceeded.suggestion": {
        ...
        "en": (
            ...
            "high-priority pages/day, then lower priority\n• Recharge or upgrade plan "
    ...
    "log.export_success_msg": {
        "zh": "日志已导出到：{path}",
        "en": "Logs exported to: {path}",
    },
    "log.export_failed": {"zh": "日志导出失败", "en": "Log Export Failed"},
    "log.export_failed_msg": {
        "zh": "导出日志时发生错误：{error}",
        "en": "Error occurred while exporting logs: {error}",
    },
    "log.no_logs_found": {
        "zh": "未找到日志文件",
    ...
    "log.level_desc": {
        "zh": "设置应用程序日志记录级别",
        "en": "Set application logging level",
    },
    ...
    "log.view_logs_desc": {
        "zh": "打开日志文件所在目录",
        "en": "Open log files directory",
    },
    "log.open_folder": {"zh": "打开文件夹", "en": "Open Folder"},
    "log.level_changed": {
        "zh": "日志级别已更改",
        "en": "Log Level Changed",
    },
    "log.level_changed_msg": {
        "zh": "日志级别已设置为 {level}",
        "en": "Log level set to {level}",
    },
}
