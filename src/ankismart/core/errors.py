...
ERROR_MESSAGES = {
    ...
    "en": {
        ...
        ErrorCode.E_MODEL_NOT_FOUND: {
            ...
            "solution": (
                "• Confirm note type is created in Anki\n"
        ...
        ErrorCode.E_REQUIRED_FIELD_MISSING: {
            ...
            "solution": (
                "• Check if card content is complete\n"
        ...
        ErrorCode.E_CONFIG_INVALID: {
            ...
            "solution": (
                "• Check required fields in settings\n"
        ...
        ErrorCode.E_FILE_TYPE_UNSUPPORTED: {
            ...
            "solution": (
                "• Supported formats: PDF, DOCX, PPTX, PNG, JPG, JPEG\n"
        ...
        ErrorCode.E_UNKNOWN: {
            ...
            "solution": (
                "• View detailed logs for more information\n"
